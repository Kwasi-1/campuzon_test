...
import type { Product, Store, Category, User, Order, DeliveryMethod, OrderStatus, Institution } from '@/types-new';
...
export const mockCategories: { value: Category; label: string; count: number }[] = [
  ...
  { value: 'fashion', label: 'Fashion', count: 205 }, // Combined clothing + accessories
  ...
  { value: 'other', label: 'Other', count: 163 }, // Combined other + furniture + sports
];
