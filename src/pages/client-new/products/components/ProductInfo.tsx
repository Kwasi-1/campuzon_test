...
export function ProductInfo({
  ...
  return (
    <div className="flex flex-col pr-1 md:pr-0">
      {/* Brand line (Store Name equivalent) */}
      <h1 className="text-xl md:text-[22px] font-normal text-gray-900 mb-1 lg:mb-2 leading-tight">
        {product.store?.name || "Campus Store"}
      </h1>

      {/* Product Name */}
      <p className="text-[14px] text-gray-600 mb-4 lg:mb-5">
        {product.name}
      </p>
      ...
      {!hideActionButtons && (
        <div className="flex gap-2 mb-4 h-[48px] md:h-[50px]">
          ...
          <button
            ...
            className={cn(
              "w-[120px] md:w-[130px] flex items-center justify-center gap-2 border text-[14px] font-semibold transition-colors bg-white",
              isInWishlist
      ...
      {/* Extra info box */}
      <div className="bg-[#f5f5f5] px-4 py-3.5 text-[13px] text-gray-600 leading-relaxed mb-6 flex flex-col md:flex-row md:items-center">
