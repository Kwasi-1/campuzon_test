...
export function ProductImageGallery({
  ...
  return (
    <div className="flex gap-4">
      {/* Vertical Thumbnails */}
      {images.length > 1 && (
        <div className="flex flex-col gap-2 w-20 md:w-24 max-h-[585px] overflow-y-auto p-0.5">
      ...
      <div className="flex-1">
        <div className="relative aspect-[4/3] rounded-xl overflow-hidden bg-[#f2f2f2] border border-gray-200">
