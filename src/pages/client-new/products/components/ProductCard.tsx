        ...
        <article className="flex flex-col h-full bg-white">
          ...
          <div className="relative aspect-square overflow-hidden bg-gray-100 rounded-md mb-3">
            <img
              ...
              alt={product.name}
              className="h-full w-full object-cover p4 mix-blend-multiply"
              loading="lazy"
            />
          ...
          <div className="flex flex-col gap-1">
            {/* Title */}
            <h3 className="text-[15px] leading-[1.3] text-gray-900 font-normal group-hover:underline line-clamp-2">
              {product.name}
            </h3>
...
function ListCard({
  ...
  return (
    ...
    >
      ...
      >
        <article className="flex flex-col sm:flex-row gap-5 py-3 border-b border-gray-200">
          {/* Image - Left Side */}
          <div className="relative w-full sm:w-[256px] aspect-square shrink-0 bg-gray-100 rounded-md overflow-hidden">
            <img
              src={
                product.images?.[0] ||
                product.thumbnail ||
              ...
              alt={product.name}
              className="w-full h-full object-cover p4 mix-blend-multiply"
              loading="lazy"
            />
          ...
          <div className="flex-1 flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex-1 min-w-0 flex flex-col gap-1">
              <h3 className="text-[17px] leading-[1.3] text-gray-900 font-normal group-hoverunderline line-clamp-2 mb-0.5">
                {product.name}
              </h3>
