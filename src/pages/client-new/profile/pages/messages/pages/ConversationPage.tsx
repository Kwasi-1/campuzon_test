...
const mockMessages: ChatMessage[] = [
  ...
  },
  {
    ...
    senderID: "user-1",
    content:
      "Hi, I just placed an order for the iPhone 14 Pro Max. When can I pick it up?",
    messageType: "text",
    attachments: null,
    isRead: true,
  ...
  },
  {
    ...
    senderID: "store-1",
    content:
      "Hello! Thank you for your order. I'll have it ready for pickup by tomorrow afternoon. I'll send you the exact location.",
    messageType: "text",
    attachments: null,
    isRead: true,
    isSystemMessage: false,
  ...
  },
  {
    ...
    senderID: "user-1",
    content:
      "Perfect! I'll be on campus all day tomorrow. Just let me know when and where.",
    messageType: "text",
    attachments: null,
    isRead: true,
    isSystemMessage: false,
  ...
  },
  {
    ...
    senderID: "store-1",
    content:
      "Your order is ready for pickup at Balme Library, near the main entrance. I'll be wearing a blue TechHub t-shirt. Come anytime between 2-5pm.",
    messageType: "text",
    attachments: null,
    isRead: true,
    isSystemMessage: false,
  ...
  },
  {
    ...
    senderID: "store-1",
    content:
      "Thank you for your purchase! Hope you enjoy your new iPhone. Please don't forget to confirm delivery in the app so I can receive the payment. Let me know if you have any questions!",
    messageType: "text",
    attachments: null,
    isRead: true,
    isSystemMessage: false,
...
export function ConversationPage() {
  ...
  const showCompleteOrderButton =
    productInCart &&
    (conversation.type === "order" || conversation.type === "inquiry");
        ...
        <div className="border-b bg-muted/30">
          <div className="container mx-auto px-4 py-2">
            ...
            >
              <img
                src={
                  conversation.product.thumbnail || "/placeholder-product.jpg"
                }
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="max-w-3xl mx-auto space-y-4">
            {messages.map((msg, index) => {
              const isOwnMessage =
                msg.senderID === user?.id || msg.senderID === "user-1";
                ...
                >
                  {!isOwnMessage && showAvatar && (
                    <Avatar className="h-7 w-7 mr-3">
                      ...
                      />
                      <AvatarFallback className="bg-primary text-white">
                        {msg.sender?.displayName?.charAt(0) || "S"}
                      </AvatarFallback>
                    </Avatar>
                  )}
            ...
            <div className="max-w-3xl mx-auto">
              <Link to="/checkout" className="block">
                <Button className="w-full gap-2" size="lg">
                  ...
                  Complete Order ({productInCart.quantity} item
                  {productInCart.quantity > 1 ? "s" : ""} in cart)
                </Button>
              </Link>
            </div>
          </div>
