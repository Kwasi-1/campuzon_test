                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div className="text-sm">
                            ...
                            <ul className="text-muted-foreground mt-1 space-y-1">
                              <li>
                                • Seller will contact you to arrange pickup
                              </li>
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="text-sm">
                          ...
                          <p className="text-green-700 dark:text-green-300 mt-1">
                            Your payment is held securely until you confirm
                            receipt of your order. Funds are only released to
                            the seller after you're satisfied.
                          </p>
                        </div>
                      </div>
                    </div>
