...
export interface ProfilePageSelectOption {
  value: string;
  label: string;
}
...
interface ProfilePageSearchFiltersProps {
  searchValue: string;
  onSearchChange: (value: string) => void;
  searchPlaceholder?: string;
  selectValue: string;
  onSelectChange: (value: string) => void;
  selectOptions: ProfilePageSelectOption[];
  selectPlaceholder?: string;
  className?: string;
}

export function ProfilePageSearchFilters({
  searchValue,
  onSearchChange,
